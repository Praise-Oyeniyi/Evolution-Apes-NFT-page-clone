...
const Header = () => {
  return (
        <div className='sticky top-0 z-40 header-outer-wrapper w-full bg-gray-900 text-white h-auto border-b-2 shadow-xl'>
            <div className="header-wrapper flex justify-between items-center w-5/6 mx-[auto] h-full cursor-pointer">
                ...
                <Scrollspy
                    ...
                    currentClassName="active" className='justify-items-center  justify-evenly flex w-[50%] flex-auto font-semibold ease-in sm:hidden'>
                ...
                <div className='w-[25%] justify-self-end flex-auto sm:hidden'>
