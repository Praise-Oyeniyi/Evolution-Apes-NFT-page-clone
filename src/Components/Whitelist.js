...
const Whitelist = () => {
  return (
    <div className="bg-gray-900 h-[1000px] w-full py-28 px-[5%] sm:py-5 sm:p-[5%]" >
        <div className="about-wrapper w-full" id='whitelist'> 
                <div className=" pt-28 flex flex-col w-full justify-center space-y-5 text-white bg-gray-900 pb-5">
                    ...
                    <motion.div initial={{y:150+'px', opacity:0}} whileInView={{ y:0, opacity:1}}  transition={{delay: .8, type:'spring', stiffness:60}} viewport={{ once: true }}>
                        <p className='w-2/6 text-base sm:w-full'>
