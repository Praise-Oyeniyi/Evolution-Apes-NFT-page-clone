  ...
  return (
    <div className=" pr-[5%] wrapper-about h-auto w-full bg-gray-900 bg-[url('Images/01.jpeg')] bg-no-repeat bg-center bg-fixed overflow-hidden" >
            <div className="about-wrapper w-full" id='about'> 
                <div className=" pt-28 flex flex-col w-6/6 justify-center space-y-5 ml-[5%] text-white bg-gray-900 pb-5 sm:space-y-2 tab:space-y-2 sm:bg-transparent tab:bg-transparent sm:pt-8 tab:pt-8">
                    ...
                    <motion.div initial={{y:150+'px', opacity:0}} whileInView={{ y:0, opacity:1}}  transition={{delay: .8, type:'spring', stiffness:60}} viewport={{ once: true }}>
                        <p className='w-2/6 text-base sm:w-full sm:text-sm tab:w-5/6 tab:text-base med:w-4/6'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur illum saepe, vero cupiditate nemo...                 
                        </p>
                    </motion.div>
                </div>

                <div className="hidden tab:block sm:block h-80 w-80 tab:w-4/6 tab:h-96 m-auto pr-[-5%] bg-[url('Images/01.jpeg')] bg-no-repeat bg-center bg-fixed bg-contain my-4"></div>
                ...
                <motion.div initial={{y:150+'px',opacity:0 }} whileInView={{ y:0, opacity:1}}  transition={{delay: .7, type:'spring', stiffness:40}} viewport={{ once: true }}>
                    <div className="about-right med:-mt-2 w-[52%] py-10 bg-gray-900 ml-[50%] text-white pr-[5%] sm:w-full sm:m-auto sm:py-5 tab:w-full tab:m-auto tab:py-5">
                    ...
                    <div className="hidden tab:block sm:block h-80 w-80 tab:w-4/6 tab:h-96 m-auto pr-[-5%] bg-[url('Images/02.jpg')] bg-no-repeat bg-center bg-fixed bg-contain"></div>
                    
                    <div className="about-left-down w-[52%] bg-gray-900 py-10 text-white pb-8 pl-[5%] -mt-5 sm:w-full sm:m-auto sm:py-5 sm:pb-0 tab:w-full tab:m-auto tab:py-5 tab:pb-0">
